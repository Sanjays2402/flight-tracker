...
export default function FlightMap() {
  ...
  + (showCwy?1:0)
  + (showJblast?1:0)
  + (showMrva?1:0) + (showAirprox?1:0) + (showMedlink?1:0) + (showCirc?1:0)
  + (showVrp?1:0)
  + (showDatis?1:0)
  + (showTdwr?1:0)
          ...
          <div className="mt-16 mr-4 w-[min(92vw,420px)] max-h-[78vh] overflow-y-auto bg-slate-950/95 backdrop-blur-xl border border-slate-800 rounded-2xl shadow-2xl" onClick={e=>e.stopPropagation()}>
            ...
            {[
              ...
              {group:'Safety & Traffic', items:[
                ...
                ['CIRC · Circling-Approach Protected-Area & Minima Conformance · 18-runway global catalogue (KJFK 13L / KLAX 24R / KSFO 19L / KORD 27L / KATL 26L / KBOS 33L / KSEA 13R / KDEN 16L / KMDW 31C / KSAN 09 / EGLL 27R / EGKK 26L / EHAM 22 / EDDF 25C / LFPG 26R / LSZH 14 / OMDB 12L / WSSS 02L) · ICAO PANS-OPS Vol II §7.3 race-track envelope (R 1.68/2.66/4.20/5.28/6.94NM Cat A/B/C/D/E post-Amdt 13) and FAA TERPS 8260.3E §2.7 Table 2-7 expansion radii (R 1.3/1.7/2.7/3.6/4.5NM A/B/C/D/E) selectable per ruleset · per-airframe lateral envelope-margin via threshold/end-arc + tangent-line race-track polygon · MDA(H)/HCH bust scorer with 100ft buffer · Cat-max IAS gate (Vat≤100/135/180/205/240kt Doc 8168 Vol I §4.1.2) · sustained bank-angle proxy via track-rate × V/g (>25° unstable per AC 91-79B §4 / AC 120-71 §4) · Cat visibility floor (1.5/1.6/2.4/3.6/6.5km Doc 8168 Vol I Pt IV) · 6 risk drivers LAT/ALT/IAS/BANK/VIS/PHASE composite max·0.78 + secondary·0.22 × ADV-MUL · hard escalators LAT≥100 in CIRC ge92 / ALT≥100 below MDA ge88 / BANK≥30° ge80 · 5 hard tiers EXCURSION outside boundary rose break-off missed approach per PANS-OPS Vol II §7.3 + AC 120-108 / UNSTABLE MDA bust or bank>30° rose-pink go-around per AC 120-108 §6 + 14 CFR §91.175(j) / PROXIMITY within BUF or VIS below minima amber monitor per Doc 8168 Vol I Pt IV / WATCH sky / CONFORM emerald per AC 120-71. MapLibre overlay race-track envelope polygons per (ICAO, RWY, Cat) tier-coloured 24-segment threshold/end arcs + tangent lines 7pct fill + dashed boundary + ambient slate Cat-C reference at unused runways + cat-coloured runway pins + axis polylines + tier-coloured halo rings 8-22px by score + rose pins EXCURSION UNSTABLE + dashed tier-coloured aircraft-to-threshold link lines + tier-coloured callsign rwy cat tier labels. Side panel 5-tier counter strip click-to-filter plus 4-cell MEAN-score WORST callsign EXCURSION-count rose UNSTABLE-count rose-pink summary plus 5 sliders SCOPE 5-80NM CIRC-ALT 1000-6000ft BUF 0.2-3NM VIS 0.5-15km ADV-MUL 50-200pct plus ruleset toggle PANS-OPS/TERPS plus 6-cat chip filter ALL/A/B/C/D/E plus HALO AREA RWY LINK LBL AXIS toggles plus search callsign/runway/airport plus AC/RWY/CAT tab switcher plus AIRCRAFT tab sorted tier-worst-first then score desc with tier color stripe plus callsign type cat-pill tier-pill plus airport-rwy phase-pill R-NM margin-NM-tier-coloured plus AGL HAA-ft delta-ft-tier-coloured IAS-vs-CatMax-tier-coloured bank-deg-tier-coloured plus tier-coloured score bar 0-100 plus 6-cell breakdown chips LAT ALT IAS BANK VIS PHASE plus tier-coloured advice citing PANS-OPS Vol II §7.3 TERPS 8260.3E §2.7 AC 120-108 91-79B AC 120-71 14 CFR §91.175(j) Doc 8168 Vol I Pt IV click-to-fly plus RUNWAYS tab per-runway with tier-worst color stripe plus icao/rwy ≤Cat-max-pill ruleset-pill plus airport-italic plus HAA MDA elev-ft in-scope-count authority plus CATEGORIES tab grouped by 6-cat with cat-pill Vat-IAS vis-min plus AC-count PANS-OPS-R TERPS-R cat-coloured mean-score bar. References ICAO Doc 8168 PANS-OPS Vol I Pt I §4.1.2 categorisation Vol I Pt IV §1 circling approach Vol II Pt I §7.3 protected area (Tables I-7-3-1/I-7-3-2 Amdt 13 split airspace/MDA) / Doc 9905 RNP-AR §4.7 / Annex 6 Pt I §4.5.5 in-flight minima / Annex 14 Vol I §3.1 reference codes / FAA Order 8260.3E TERPS §2.7 Circling Approach Areas + Table 2-7 expansion radii / AC 120-108 Continuous Descent Final Approach / AC 120-71 SOP §4 / AC 90-66B §10 traffic patterns / AC 91-79B §4 stabilised approach / Order 8900.1 V4 Ch4 §3 circling restrictions / 14 CFR §91.175(j) commercial circling night prohibition / EASA AMC1 CAT.OP.MPA.110 commercial circling / EASA CS-AWO §3 LVO restrictions / EUROCONTROL EAPPRI ed.3 Approach Path Monitoring §4 / UK CAA CAP 696 / CAP 437 §6 / ATSB AO-2018-016 Mildura Cat-C circling overrun / NTSB AAR-13-04 Lex KLEX runway misidentification / NTSB AAR-19-02 AS3296 circling unstable / AAIB EW/C2017/04/02 EGGD circling MDA bust / BFU 0X005-13 EDDF Cat-D lateral excursion', showCirc, ()=>{ const nv=!showCirc; setShowCirc(nv); lsSet('ft-circ', nv) }],
