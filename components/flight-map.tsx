...
export default function FlightMap() {
  ...
  + (showCwy?1:0)
  + (showJblast?1:0)
  + (showMrva?1:0) + (showAirprox?1:0) + (showMedlink?1:0) + (showVmoMmo?1:0) + (showRotor?1:0)
  + (showVrp?1:0)
  + (showDatis?1:0)
  + (showTdwr?1:0)
          ...
          <div className="mt-16 mr-4 w-[min(92vw,420px)] max-h-[78vh] overflow-y-auto bg-slate-950/95 backdrop-blur-xl border border-slate-800 rounded-2xl shadow-2xl" onClick={e=>e.stopPropagation()}>
            ...
            {[
              ...
              {group:'Safety & Traffic', items:[
                ...
                ['ROTOR · Rotary-wing mission classifier & monitor · per-airframe rotorcraft scorer with 8-mission auto-classifier (HEMS / OFFSHORE / SAR / LE / ENG / TOUR / UTIL / EXEC / UNK) from operator-prefix + ADS-B cat-B + slow/low signature · 6 rotor-specific drivers CFIT-LL (height·airspeed) / VRS (vortex-ring state envelope at <30kt descending) / AUTOROT (HV avoid-curve §27.79/§29.79) / WIRE (low-and-slow exposure AC 90-114B §8) / DVE (brown-out hover regime) / NIGHT (NVG unaided penalty §61.57(b)) · hard escalators VRS≥70+descending=88 / CFIT-LL≥80=86 / HV-violation=82 · 6 tiers EMERGENCY/CRITICAL/WARN/CAUTION/WATCH/NOMINAL · mission-coloured halos + pins + labels · MISSIONS/AIRCRAFT/OPERATORS tabs · (FAA-H-8083-21B Ch11/12 / 14 CFR Part 27/29/133/135 §135.601-621 / Part 136 Subpart A / Part 137 / AC 135-14B / AC 136-1 / AC 133-1B / AC 90-114B / AC 60-22 / AC 60-25C / AC 91-110 / Order 8900.1 V3 Ch20 Ch33 / ICAO Annex 6 Pt III §IV §V / Annex 12 SAR / Doc 9966 HEMS / Doc 9261 Heliport / Doc 9731 IAMSAR Vol III / Doc 9870 §6 / Doc 8896 §3.4 / EASA SPA.HEMS / SPA.HOFO / SPA.SAR / SPA.NVIS / HESLO / Easy Access SPO / CAP 437 / CAP 999 / TC TP 4938 / TM 1-203 / FM 3-04 §3 / API RP 2L / HSAC RP 92 / NTSB SR-13-01 HEMS / SR-19-01 air-tour / SR-19-02 CFIT / SR-94-01 wire-strike / USHST H-SE-127 / IHST SMS Toolkit ed.2 / HFDM Toolkit / HAI Land & Live / IS-BAH IBAC / RTDNA ENG)', showRotor, ()=>{ const nv=!showRotor; setShowRotor(nv); lsSet('ft-rotor', nv) }],
