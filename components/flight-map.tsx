    ...
    <div className="relative h-screen w-screen overflow-hidden bg-[#07090d]">
      ...
      <CommandPalette
        ...
        actions={useMemo<CPAction[]>(() => ([
          ...
          { id: 'toggle-fir', group: 'View', label: showFir ? 'Close FIR Crossings Monitor' : 'FIR / ARTCC Crossings Monitor', run: () => { const nv = !showFir; setShowFir(nv); lsSet('ft-fir', nv) }, keywords: ['fir', 'artcc', 'crossing', 'boundary', 'handoff', 'sector', 'controller', 'workload', 'oceanic', 'flow', 'centre', 'center'] },
