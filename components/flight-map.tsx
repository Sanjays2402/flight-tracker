    ...
    <div className="relative h-screen w-screen overflow-hidden bg-[#07090d]">
      ...
      <CommandPalette
        ...
        actions={useMemo<CPAction[]>(() => ([
          ...
          { id: 'toggle-wow', group: 'View', label: showWow ? 'Close WoW · Squat-Switch · Air-Ground Logic Monitor' : 'WoW / Squat-Switch · Air-Ground Logic Discrepancy & Ground-Spoiler / Autobrake / T-R Interlock Coherency Monitor (ATA-32-09 / ATA-27-60 / ATA-32-42 / ATA-78-30 · 6-class WoW catalogue HVY-Q LGCIU-3 24-sensor / HVY LGCIU-2 16-sensor / NRW LGCIU-2 6-sensor / RGN PSEU-1 / BIZ PSEU-1 / TBP PSEU-1 · NLG+MLG-L+MLG-R squat-pair voting · RA-truth vs WoW disagreement · strut-pressure psi cross-check · Nz vertical-load · ground-spoiler asymmetry / late-deploy detection / T-R interlock chain WoW+RA+TLA · TOCWS gate Spanair JK5022 mis-arm escalation · 5 risk drivers MIS RAD GSP INT TOC · phase ROLLOUT/FLARE/TKO/APP/TAXI/CRZ multiplier · 5 tiers SPANAIR ASYM WATCH OK IDLE · refs 14 CFR 25.703 25.729 25.671 25.933 25.1309 25.1322 / AC 25.703-1 / AC 25-7D §32 / CS-25.703 / CS-25.729 / ARINC 429 lbl 270 271 232 / ARINC 706 738 ADIRU / Boeing FCOM 9.40 / Airbus DSC-32-LGCIU / NTSB AAR-09-09 CIAIAC A-032/2008 Spanair JK5022 MD-82 / UAE-GCAA AAIS 13/2016 Emirates EK521 B777 / TSB A05H0002 Air France 358 A340 YYZ / NTSB AAR-14-01 Asiana 214 / AAIB 4/2010 G-OAKR / AAIB 5/2018 G-EZTD / FAA AD 2014-22-04 / AD 2018-11-02 / EASA AD 2019-0036 / Boeing SB 737-32-1604 / Airbus SB A320-32-1554 / Boeing AERO Q3-2017)', run: () => { const nv = !showWow; setShowWow(nv); lsSet('ft-wow', nv) }, keywords: ['wow', 'squat switch', 'air ground', 'lgciu', 'pseu', 'proximity sensor', 'ground spoiler', 'autobrake', 'thrust reverser', 'interlock', 'tocws', 'takeoff configuration', 'spanair', 'jk5022', 'emirates', 'ek521', 'air france 358', 'asiana 214', 'radio altimeter', 'strut pressure', 'oleo', 'rollout', 'flare', 'mlg', 'nlg', 'ata 32', 'ata 27', 'ata 78', 'cfr 25.703', 'cfr 25.729', 'arinc 270', 'arinc 271', 'lgciu-2', 'lgciu-3', 'aar-09-09', 'aais 13/2016', 'a05h0002'] },
