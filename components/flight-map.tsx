    ...
    <div className="relative h-screen w-screen overflow-hidden bg-[#07090d]">
      ...
      <CommandPalette
        ...
        actions={useMemo<CPAction[]>(() => ([
          ...
          { id: 'toggle-vib', group: 'View', label: showVib ? 'Close Engine Vibration / FBO Monitor' : 'Engine Vibration & Fan-Blade-Imbalance Monitor (ATA-77) · per-engine N1 / N2 IPS broadband vibration · advisory / caution / red-line thresholds · main-bearing spectral tone · fan-trim FBO precursor · EGT-margin erosion · phase-weighted per 14 CFR 33.63 · 33.83 · 33.94 · AC 33-9 · AC 33.94-1 · AC 120-42B App 2 · Boeing FCOM 7.30 · Airbus PRO-NOR-SOP-23 · NTSB AAR-19/03 SWA1380', run: () => { const nv = !showVib; setShowVib(nv); lsSet('ft-vib', nv) }, keywords: ['vibration', 'vib', 'n1', 'n2', 'ips', 'fan', 'core', 'lpt', 'fbo', 'fan blade out', 'imbalance', 'bearing', 'spectral', 'ata-77', 'ata 77', 'broadband', 'evmu', 'arinc 624', 'arinc 720', 'ac 33.94', 'ac 33-9', '33.63', '33.83', '33.94', 'cfm56', 'leap', 'genx', 'trent', 'gtf', 'swa1380', 'ua232', 'engine'] },
