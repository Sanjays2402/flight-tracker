...
export default function FlightMap() {
  ...
  + (showCwy?1:0)
  + (showJblast?1:0)
  + (showMrva?1:0) + (showAirprox?1:0) + (showMedlink?1:0) + (showCirc?1:0) + (showVmoMmo?1:0) + (showNemo?1:0)
  + (showVrp?1:0)
  + (showDatis?1:0)
  + (showTdwr?1:0)
          ...
          <div className="mt-16 mr-4 w-[min(92vw,420px)] max-h-[78vh] overflow-y-auto bg-slate-950/95 backdrop-blur-xl border border-slate-800 rounded-2xl shadow-2xl" onClick={e=>e.stopPropagation()}>
            ...
            {[
              ...
              {group:'Safety & Traffic', items:[
                ...
                ['CIRC · Circling-Approach Protected-Area & Minima Conformance · 18-runway global catalogue (KJFK 13L / KLAX 24R / KSFO 19L / KORD 27L / KATL 26L / KBOS 33L / KSEA 13R / KDEN 16L / KMDW 31C / KSAN 09 / EGLL 27R / EGKK 26L / EHAM 22 / EDDF 25C / LFPG 26R / LSZH 14 / OMDB 12L / WSSS 02L) · ICAO PANS-OPS Vol II §7.3 race-track envelope (R 1.68/2.66/4.20/5.28/6.94NM Cat A/B/C/D/E post-Amdt 13) and FAA TERPS 8260.3E §2.7 Table 2-7 (R 1.3/1.7/2.7/3.6/4.5NM A/B/C/D/E) selectable per ruleset · per-airframe lateral envelope-margin via threshold/end-arc + tangent-line race-track polygon · MDA(H)/HCH bust scorer with 100ft buffer · Cat-max IAS gate (Vat≤100/135/180/205/240kt Doc 8168 Vol I §4.1.2) · sustained bank-angle proxy via track-rate × V/g (>25° unstable per AC 91-79B §4 / AC 120-71 §4) · Cat visibility floor (1.5/1.6/2.4/3.6/6.5km Doc 8168 Vol I Pt IV) · 6 risk drivers LAT/ALT/IAS/BANK/VIS/PHASE composite max·0.78 + secondary·0.22 × ADV-MUL · 5 tiers EXCURSION/UNSTABLE/PROXIMITY/WATCH/CONFORM · (ICAO Doc 8168 PANS-OPS Vol I Pt I §4.1.2 / Vol I Pt IV §1 / Vol II Pt I §7.3 Tables I-7-3-1/I-7-3-2 Amdt 13 / Doc 9905 §4.7 / Annex 6 Pt I §4.5.5 / Annex 14 Vol I §3.1 / FAA Order 8260.3E §2.7 / AC 120-108 / AC 120-71 §4 / AC 90-66B §10 / AC 91-79B §4 / Order 8900.1 V4 Ch4 §3 / 14 CFR §91.175(j) / EASA AMC1 CAT.OP.MPA.110 / CS-AWO §3 / EUROCONTROL EAPPRI ed.3 §4 / UK CAA CAP 696 / CAP 437 §6 / ATSB AO-2018-016 Mildura / NTSB AAR-13-04 Lex KLEX / AAR-19-02 AS3296 / AAIB EW/C2017/04/02 EGGD / BFU 0X005-13 EDDF)', showCirc, ()=>{ const nv=!showCirc; setShowCirc(nv); lsSet('ft-circ', nv) }],
